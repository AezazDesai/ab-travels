...
export const metadata: Metadata = {
  ...
  description:
    "Contact AB Travels in At-Tankal, Navsari for travel packages, Umrah bookings and queries. Reach us on WhatsApp, phone or visit our office.",
};
      ...
      <div className="hero-gradient pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sky-100/70 text-lg max-w-2xl mx-auto">
            Have a question? Want to book a package? Reach out directly — we're
            always available.
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-6">
              ...
              <p className="text-[var(--text-secondary)]">
                The fastest way to reach us is WhatsApp. We typically respond
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">
                    +91 {WHATSAPP_NUMBER} · Usually replies in minutes
                  </p>
                </div>
              </a>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-[var(--gray-soft)] space-y-5">
                {[
                  ...
                  },
                  {
                    ...
                    label: "Address",
                    value:
                      "Maa Gayatri Complex, Block 101, Char Rasta, Tankal, Navsari, Gujarat – 396560",
                  ...
                  <div key={item.label} className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {item.href ? (
                        <a
                          href={item.href}
                          className="text-sm font-medium text-[var(--navy)] hover:text-[var(--sky-dark)] transition-colors"
                        >
                          {item.value}
                        </a>
                      ) : (
