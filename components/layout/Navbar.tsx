            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span
                  className={cn(
                    ...
                    scrolled
                      ? "bg-[var(--sky)]/20 text-[var(--sky-dark)]"
              ...
              <p
                className={cn(
                  ...
                  scrolled ? "text-[var(--text-muted)]" : "text-sky-200",
                )}
              >
                At-Tankal, Navsari
              </p>
          ...
          <div>
            ...
            >
              <span className="flex items-center gap-3">
                <Package size={16} className="text-[var(--sky-dark)]" />{" "}
                Packages
              </span>
              <ChevronDown
                size={15}
            ...
            <div
              className={cn(
                ...
                pkgMobileOpen ? "max-h-64" : "max-h-0",
              )}
            >
