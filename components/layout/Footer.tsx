        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-xl px-3 py-2 mb-5">
              ...
              <div>
                <p className="text-[10px] text-sky-300/70 leading-none">
                  MSME Registered
                </p>
          ...
          <div>
            ...
            {/* Legal links */}
            <h4
              className="font-bold text-base mt-8 mb-4 text-[var(--sky-light)]"
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
              Legal
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-sm text-sky-100/70">
                ...
                />
                <span>
                  Maa Gayatri Complex, Block 101,
                  <br />
                  Char Rasta, Tankal,
                  <br />
                  Navsari, Gujarat – 396560
                </span>
              </li>
              <li>
                <a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
            <p className="text-sky-100/50 text-xs">
              © 2015–{new Date().getFullYear()} AB Travels · The AB Group. All
              rights reserved.
            </p>
